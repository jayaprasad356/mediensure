...
public class NotVerifiedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_not_verified, container, false);
        ...
        chipOPD.setOnClickListener(v -> {
            setBackgroudsandVisibals();
            rvOpd.setVisibility(View.VISIBLE);
            chipOPD.setChipBackgroundColor(ColorStateList.valueOf(activity.getResources().getColor(R.color.lightGree)));
            loadOPDdata();
        });
        chipDental.setOnClickListener(v -> {
            setBackgroudsandVisibals();
        ...
        chipPharmacy.setOnClickListener(v -> {
            setBackgroudsandVisibals();
        ...
        chipRadiology.setOnClickListener(v -> {
            setBackgroudsandVisibals();
